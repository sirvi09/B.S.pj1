...
const AdminSidebar = () => {
    ...
    const adminNavlinks = [
        ...
        {name: 'List Bookings',path: '/admin/list-bookings',icon: 
        ListCollapseIcon},
    ]
    return(
        <div className='h-[calc(100vh-64px)] md:flex flex-col items-center pt-8
        max-w-13 md:max-w-60 w-full border-r border-gray-300/20 tetx-sm'>
            ...
            <div className='w-full'>
                {adminNavlinks.map((link, index)=>(
                 ...
                 msx-md:justify-center gap-2 w-full py-2.5 min-md:pl-10 first:mt-6
